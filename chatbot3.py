...
if not API_KEY:
    raise RuntimeError("❌ Error: GEMINI_API_KEY is missing in .env file or environment variables.")
...
def main():
    ...
    model = genai.GenerativeModel("gemini-1.5-pro")  # أحدث إصدار مناسب من Gemini
